...
import 'Screens/FriendsBirthday.dart';
import 'Screens/HomeScreen.dart';
import 'Screens/addfriend.dart';
import 'Screens/nationalDay.dart';

class ButtomNavigationBar extends StatefulWidget {
  const ButtomNavigationBar({super.key});

  @override
  State createState() => _ButtomNavigationBarState();
}
...
class _ButtomNavigationBarState extends State {
  ...
  final List _pages = [
    ...
    const NationalDayPage(),
    const FriendsBirthdayPage(),
          AddFriendPage(),
  ];
